...
"        (default: all).\n"
"\n"
"        Selection keywords (equivalent PDBx category dataitems in parentheses):\n"
"            all       - all atoms;\n"
...
"                     selected angles should be in (e.g. angles 'chi1=90..160'\n"
"                     or 'psi=60..70, phi=50..80');\n"
