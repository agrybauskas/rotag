...
std::vector<double>
find_euler_angle(std::vector<double> mid_atom_coord,
                 std::vector<double> up_atom_coord,
                 std::vector<double> side_atom_coord) {
    double alpha_rad;
    double beta_rad;
...
AlgebraicMatrix matrix_product(AlgebraicMatrix left_matrix,
    ...
    std::vector<std::vector<double>> local_left_matrix =
        left_matrix.get_matrix();
    std::vector<std::vector<double>> local_right_matrix =
        right_matrix.get_matrix();
