...
$(dirname "$0")/../scripts/sample_bond_parameters "0..2" 1 0 0
$(dirname "$0")/../scripts/sample_bond_parameters "0..2" 1 0 1
$(dirname "$0")/../scripts/sample_bond_parameters "0..2" 1 1 0
$(dirname "$0")/../scripts/sample_bond_parameters "0..2" 1 1 1
