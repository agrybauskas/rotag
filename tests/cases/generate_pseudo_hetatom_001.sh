...
atom_id=152
angle_and_length_ranges="chi1 -1*pi,1*pi & r1 -0.1,0.1 & r2 -0.1,0.1 & theta1 -0.1*pi,0.1*pi & theta2 -0.1*pi,0.1*pi"
num_of_angles_and_lengths="chi1 20 & r1 1 & r2 1 & theta1 1 & theta2 1"
