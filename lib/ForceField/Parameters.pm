...
sub force_field
{
    ...
    for my $dihedral_angle_name ( @{ $dihedral_angle_names } ) {
        ...
        my $atom_name_3 = $dihedral_angle_name->{'label_atom_3_id'};
        my $atom_name_4 = $dihedral_angle_name->{'label_atom_4_id'};
        ...
        $force_field_parameters{'_[local]_dihedral_angle_name'}
            ...
            $angle_name;
        $force_field_parameters{'_[local]_reverse_dihedral_angle_name'}
                               {$residue_name}
                               {$angle_name} =
            "${atom_name_1}-${atom_name_2}-${atom_name_3}-${atom_name_4}";
    }
    ...
    # Restructuring parameters of heteroatom residue names.
